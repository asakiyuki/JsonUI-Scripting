...
export interface Special {
    ...
    /**
     * The first color of the gradient, represented as a `ColorVector4` (RGBA).
     */
    color1?: ColorVector4;

    /**
     * The second color of the gradient, represented as a `ColorVector4` (RGBA).
     */
    color2?: ColorVector4;

    /**
     * The color of the text, represented as a `ColorVector4` (RGBA).
     */
    text_color?: ColorVector4;

    /**
     * The background color, represented as a `ColorVector4` (RGBA).
     */
    background_color?: ColorVector4;

    /**
     * The primary color, represented as a `ColorVector4` (RGBA).
     */
    primary_color?: ColorVector4;

    /**
     * The secondary color, represented as a `ColorVector4` (RGBA).
     */
...
interface ProgessBar {
    /**
     * The primary color of the progress bar, represented as a `ColorVector4` (RGBA).
     */
    primary_color?: ColorVector4;

    /**
     * The secondary color of the progress bar, represented as a `ColorVector4` (RGBA).
     */
    secondary_color?: ColorVector4;
}
