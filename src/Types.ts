...
export interface JsonUIProperty {
    visible?: ColorHex | Bool,
    enabled?: ColorHex | Bool,
    layer?: ColorHex | Num,
    alpha?: ColorHex | Num,
    propagate_alpha?: ColorHex | Bool,
    clips_children?: ColorHex | Bool,
    allow_clipping?: ColorHex | Bool,
    clip_offset?: ColorHex | Vector2,
    clip_state_change_event?: ColorHex | string,
    enable_scissor_test?: ColorHex | Bool,
    property_bag?: ColorHex | Obj,
    selected?: ColorHex | Bool,
    use_child_anchors?: ColorHex | Bool,
    disable_anim_fast_forward?: ColorHex | Bool,
    animation_reset_name?: ColorHex | string,
    ignored?: ColorHex | Bool,
    grid_position?: ColorHex | Vector2,
    collection_index?: ColorHex | Num,
    size?: ColorHex | Vector2_str,
    max_size?: ColorHex | Vector2_str,
    min_size?: ColorHex | Vector2_str,
    offset?: ColorHex | Vector2_str,
    anchor_from?: ColorHex | Anchor,
    anchor_to?: ColorHex | Anchor,
    inherit_max_sibling_width?: ColorHex | Bool,
    inherit_max_sibling_height?: ColorHex | Bool,
    use_anchored_offset?: ColorHex | Bool,
    contained?: ColorHex | Bool,
    draggable?: ColorHex | Direction,
    follows_cursor?: ColorHex | Bool,
    grid_dimensions?: ColorHex | Vector2,
    maximum_grid_items?: ColorHex | Num,
    grid_dimension_binding?: ColorHex | string,
    grid_rescaling_type?: ColorHex | Direction,
    grid_fill_direction?: ColorHex | Direction,
    grid_item_template?: ColorHex | string,
    precached_grid_item_count?: ColorHex | Num,
    text?: ColorHex | string,
    color?: ColorHex | Vector3,
    locked_color?: ColorHex | Vector3,
    shadow?: ColorHex | Bool,
    hide_hyphen?: ColorHex | Bool,
    notify_on_ellipses?: ColorHex | ArrString,
    enable_profanity_filter?: ColorHex | Bool,
    locked_alpha?: ColorHex | Num,
    font_scale_factor?: ColorHex | Num,
    localize?: ColorHex | Bool,
    line_padding?: ColorHex | Num,
    font_size?: ColorHex | FontSize | string,
    backup_font_type?: ColorHex | FontType | string,
    text_alignment?: ColorHex | Anchor | string,
    texture?: ColorHex | string,
    allow_debug_missing_texture?: ColorHex | Bool,
    uv?: ColorHex | Vector2,
    uv_size?: ColorHex | Vector2,
    texture_file_system?: ColorHex | TextureFileSystem,
    nineslice_size?: ColorHex | Vector2 | Vector4 | Num,
    tiled?: ColorHex | Bool | Vector2,
    tiled_scale?: ColorHex | Vector2,
    clip_direction?: ColorHex | ClipDirection,
    clip_ratio?: ColorHex | Num,
    clip_pixelperfect?: ColorHex | Bool,
    keep_ratio?: ColorHex | Bool,
    bilinear?: ColorHex | Bool,
    fill?: ColorHex | Bool,
    "$fit_to_width"?: ColorHex | Bool,
    zip_folder?: ColorHex | string,
    grayscale?: ColorHex | Bool,
    force_texture_reload?: ColorHex | Bool,
    base_size?: ColorHex | Vector2,
    modal?: ColorHex | Bool,
    inline_modal?: ColorHex | Bool,
    always_listen_to_input?: ColorHex | Bool,
    always_handle_pointer?: ColorHex | Bool,
    always_handle_controller_direction?: ColorHex | Bool,
    hover_enabled?: ColorHex | Bool,
    prevent_touch_input?: ColorHex | Bool,
    consume_event?: ColorHex | Bool,
    consume_hover_events?: ColorHex | Bool,
    gesture_tracking_button?: ColorHex | Bool,
    default_focus_precedence?: ColorHex | Num,
    focus_enabled?: ColorHex | Bool,
    focus_wrap_enabled?: ColorHex | Bool,
    focus_magnet_enabled?: ColorHex | Bool,
    focus_identifier?: ColorHex | string,
    focus_change_down?: ColorHex | string,
    focus_change_up?: ColorHex | string,
    focus_change_left?: ColorHex | string,
    focus_change_right?: ColorHex | string,
    focus_mapping?: ColorHex | any[] | string,
    focus_container?: ColorHex | Bool,
    use_last_focus?: ColorHex | Bool,
    focus_navigation_mode_left?: ColorHex | FocusNavigationMode | string,
    focus_navigation_mode_right?: ColorHex | FocusNavigationMode | string,
    focus_navigation_mode_down?: ColorHex | FocusNavigationMode | string,
    focus_navigation_mode_up?: ColorHex | FocusNavigationMode | string,
    focus_container_custom_left?: ColorHex | FocusContainerCustom[] | string,
    focus_container_custom_right?: ColorHex | FocusContainerCustom[] | string,
    focus_container_custom_down?: ColorHex | FocusContainerCustom[] | string,
    focus_container_custom_up?: ColorHex | FocusContainerCustom[] | string,
    default_control?: ColorHex | string,
    hover_control?: ColorHex | string,
    pressed_control?: ColorHex | string,
    locked_control?: ColorHex | string,
    radio_toggle_group?: ColorHex | Bool,
    toggle_name?: ColorHex | string,
    toggle_default_state?: ColorHex | Bool,
    toggle_group_forced_index?: ColorHex | Num,
    toggle_group_default_selected?: ColorHex | Num,
    reset_on_focus_lost?: ColorHex | Bool,
    toggle_on_hover?: ColorHex | string,
    toggle_on_button?: ColorHex | string,
    toggle_off_button?: ColorHex | string,
    enable_directional_toggling?: ColorHex | Bool,
    toggle_grid_collection_name?: ColorHex | string,
    unchecked_control?: ColorHex | string,
    checked_control?: ColorHex | string,
    unchecked_hover_control?: ColorHex | string
    checked_hover_control?: ColorHex | string
    unchecked_locked_control?: ColorHex | string,
    checked_locked_control?: ColorHex | string,
    unchecked_locked_hover_control?: ColorHex | string,
    checked_locked_hover_control?: ColorHex | string,
    dropdown_name?: ColorHex | string,
    dropdown_content_control?: ColorHex | string,
    dropdown_area?: ColorHex | string,
    sound_name?: ColorHex | string,
    sound_volume?: ColorHex | Num,
    sound_pitch?: ColorHex | Num,
    sounds?: ColorHex | SoundObject[] | string,
    collection?: ColorHex | Collection | string,
    text_box_name?: ColorHex | string,
    text_edit_box_grid_collection_name?: ColorHex | string,
    constrain_to_rect?: ColorHex | Bool,
    enabled_newline?: ColorHex | Bool,
    text_type?: ColorHex | TextType,
    max_length?: ColorHex | Num,
    text_control?: ColorHex | string,
    place_holder_control?: ColorHex | string,
    can_be_deselected?: ColorHex | Bool,
    always_listening?: ColorHex | Bool,
    virtual_keyboard_buffer_control?: ColorHex | string,
    slider_track_button?: ColorHex | string,
    slider_small_decrease_button?: ColorHex | string,
    slider_small_increase_button?: ColorHex | string,
    slider_steps?: ColorHex | Num,
    slider_direction?: ColorHex | Orientation,
    slider_timeout?: ColorHex | Num,
    slider_collection_name?: ColorHex | string,
    slider_name?: ColorHex | string,
    slider_select_on_hover?: ColorHex | Bool,
    slider_selected_button?: ColorHex | string,
    slider_deselected_button?: ColorHex | string,
    slider_box_control?: ColorHex | string,
    background_control?: ColorHex | string,
    background_hover_control?: ColorHex | string,
    progress_control?: ColorHex | string,
    progress_hover_control?: ColorHex | string,
    scrollbar_track_button?: ColorHex | string,
    scrollbar_touch_button?: ColorHex | string,
    scroll_speed?: ColorHex | Num,
    gesture_control_enabled?: ColorHex | Bool,
    always_handle_scrolling?: ColorHex | Bool,
    touch_mode?: ColorHex | Bool,
    scrollbar_box?: ColorHex | string,
    scrollbar_track?: ColorHex | string,
    scroll_view_port?: ColorHex | string,
    scroll_content?: ColorHex | string,
    scroll_box_and_track_panel?: ColorHex | string,
    jump_to_bottom_on_update?: ColorHex | Bool,
    renderer?: ColorHex | Renderer | string,
    gradient_direction?: ColorHex | Orientation | string,
    color1?: ColorHex | Vector4,
    color2?: ColorHex | Vector4,
    text_color?: ColorHex | Vector4,
    background_color?: ColorHex | Vector4,
    primary_color?: ColorHex | Vector4,
    secondary_color?: ColorHex | Vector4,
    camera_tilt_degrees?: ColorHex | Num,
    starting_rotation?: ColorHex | Num,
    use_selected_skin?: ColorHex | Bool,
    use_uuid?: ColorHex | Bool,
    use_skin_gui_scale?: ColorHex | Bool,
    use_player_paperdoll?: ColorHex | Bool,
    rotation?: ColorHex | RotationAuto | string,
    end_event?: ColorHex | string,
    render_only_when_topmost?: ColorHex | Bool,
    screen_not_flushable?: ColorHex | Bool,
    always_accepts_input?: ColorHex | Bool,
    render_game_behind?: ColorHex | Bool,
    absorbs_input?: ColorHex | Bool,
    is_showing_menu?: ColorHex | Bool,
    is_modal?: ColorHex | Bool,
    should_steal_mouse?: ColorHex | Bool,
    low_frequency_rendering?: ColorHex | Bool,
    screen_draws_last?: ColorHex | Bool,
    vr_mode?: ColorHex | Bool,
    force_render_below?: ColorHex | Bool,
    send_telemetry?: ColorHex | Bool,
    close_on_player_hurt?: ColorHex | Bool,
    cache_screen?: ColorHex | Bool,
    load_screen_immediately?: ColorHex | Bool,
    gamepad_cursor?: ColorHex | Bool,
    gamepad_cursor_deflection_mode?: ColorHex | Bool,
    should_be_skipped_during_automation?: ColorHex | Bool,
    inner_radius?: ColorHex | Num,
    outer_radius?: ColorHex | Num,
    state_controls?: ColorHex | ArrString,
    slice_count?: ColorHex | Num,
    button_name?: ColorHex | string,
    iterate_left_button_name?: ColorHex | string,
    iterate_right_button_name?: ColorHex | string,
    initial_button_slice?: ColorHex | Num,
    tts_name?: ColorHex | string,
    tts_control_header?: ColorHex | string,
    tts_section_header?: ColorHex | string,
    tts_control_type_order_priority?: ColorHex | Num,
    tts_index_priority?: ColorHex | Num,
    tts_toggle_on?: ColorHex | string,
    tts_toggle_off?: ColorHex | string,
    tts_override_control_value?: ColorHex | string,
    tts_inherit_siblings?: ColorHex | Bool,
    tts_value_changed?: ColorHex | string,
    ttsSectionContainer?: ColorHex | Bool,
    tts_ignore_count?: ColorHex | Bool,
    tts_skip_message?: ColorHex | Bool,
    tts_value_order_priority?: ColorHex | Num,
    tts_play_on_unchanged_focus_control?: ColorHex | Bool,
    tts_ignore_subsections?: ColorHex | Bool,
    text_tts?: ColorHex | string,
    use_priority?: ColorHex | Bool,
    priority?: ColorHex | Bool,
    [key: string]: ColorHex | any
}
